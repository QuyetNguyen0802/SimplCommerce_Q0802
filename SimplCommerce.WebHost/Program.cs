...
void ConfigureService()
{
    ...
    builder.Services.AddAutoMapper(typeof(Program).Assembly); // Hoặc những assembly chứa các Profile của bạn


    builder.Services.AddAutoMapper(
        typeof(Program).Assembly,
        typeof(Accessory).Assembly,
        typeof(AccessoryResultDto).Assembly
    );
    ...
    //// Đăng ký dịch vụ IAccessoryService
